...
const Streams: NextPage = () => {
  return (
    <div className="space-y-4 divide-y-2 py-10">
      ...
      <button className="fixed bottom-20 right-5 cursor-pointer rounded-full border-transparent bg-orange-400 p-3 text-white shadow-xl transition-colors hover:bg-orange-500">
        <svg
          className="h-6 w-6"
          fill="none"
          stroke="currentColor"
