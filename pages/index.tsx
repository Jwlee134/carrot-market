...
const Home: NextPage = () => {
  return (
    <div className="grid min-h-screen gap-5 bg-slate-400 py-20 px-20 md:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-3xl bg-white p-7 shadow-xl sm:bg-red-400 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-400 2xl:bg-pink-400">
